...
class Matern52(Stationary):
	...
	def __init__(self, ndim, ard=True, input_map=None, max_ls=None, trainable_amp=True):
		super(Matern52, self).__init__(ndim, ard, input_map, max_ls, trainable_amp)
	...
	def forward(self, input1, input2=None):
		...
		gram_mat = matern52.Matern52.apply(self.input_map(input1), self.input_map(input2), self.log_ls)
