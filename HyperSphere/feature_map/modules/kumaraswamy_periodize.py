...
class KumaraswamyPeriodize(GPModule):

	def __init__(self, ndim, max_input=None):
		super(KumaraswamyPeriodize, self).__init__()
	...
	def forward(self, input):
		...
		periodize_input = (1 - torch.cos(input / max_value * math.pi)) * 0.5
		return max_value * (1 - (1 - periodize_input ** a) ** b)
